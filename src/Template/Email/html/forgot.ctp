...
<p>You can set your new password by following this <a href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'reset', 'prefix' => false, 'plugin' => false, 'xxb'.'bxx'.$token]) ?>">link</a>.</p>
