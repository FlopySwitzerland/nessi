...
class EstablishmentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'gmapid' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2017-03-05 13:01:33',
            'modified' => '2017-03-05 13:01:33'
        ],
    ];
}
